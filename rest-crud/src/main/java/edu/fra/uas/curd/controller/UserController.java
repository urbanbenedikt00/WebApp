...
public class UserController {
    ...
    // http://127.0.0.1/users/find?id=1
    ...
    // http://127.0.0.1/users/add?firstName=Celine&lastName=Clever&email=celine.clever%40example.com&password=123456
    ...
    // http://127.0.0.1/users/updated?id=2&firstName=Alice&lastName=Abraham&email=alice%40example.com&password=123A456
